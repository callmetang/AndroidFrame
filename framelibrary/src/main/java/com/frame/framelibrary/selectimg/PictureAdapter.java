...
//        Picasso.get().load(new File(item.path)).into(imageView);
            ...
            GlideUtils.loadToFile(mContext, item.path, imageView);
//            Glide.with(mContext).load(new File(item.path)).error(R.drawable.ic_launcher_background).placeholder(R.drawable.ic_launcher_background).into(imageView);
